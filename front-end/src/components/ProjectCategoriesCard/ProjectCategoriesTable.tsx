...
const ProjectCategoriesTable: React.FC<ProjectCategoriesTableProps> = ({ categories, handleTableAction, isCategoryLoading }) => {
                ...
                {categories.slice(page * rowsPerPage, page * rowsPerPage + rowsPerPage).map((category) => (
                  <StyledTableRow key={category._id}>
                    ...
                    <StyledTableCell align="right">
                      <IconButton onClick={() => { handleTableAction(SCREEN_MODES.VIEW, category._id) }}>
                        <Visibility />
                      </IconButton>
                      <IconButton onClick={() => { handleTableAction(SCREEN_MODES.EDIT, category._id) }}>
                        <Edit />
                      </IconButton>
